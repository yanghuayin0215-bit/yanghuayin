...
def build_model():
    model = models.Sequential([
        ...
        # 一，新增第四个卷积层 - 增加模型深度(128个卷积核，大小为3×3，激活函数使用relu)
        ####begin
        layers.Conv2D(128,(3,3),actication = 'relu'),
        ####end

        # 全连接层
        layers.Flatten(),
        #二，增加全连接层神经数量(从64至128)
        #三，新增一个全连接层加深网络(参数为64个神经元，以relu为激活函数)
        ####begin
...
try:
    ...
    model = build_model()
    # 四，修改下方代码将epochs加至10，验证集比例改为0.2
    ####begin
